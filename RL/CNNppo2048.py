...
def costum_cnn(scaled_images, **kwargs):
    """
    ...
    """
    activ = tf.nn.relu
    layer_1 = activ(conv(scaled_images, 'c1', n_filters=128, filter_size=2, stride=1, init_scale=np.sqrt(2), **kwargs))
    layer_2 = activ(conv(layer_1, 'c2', n_filters=128, filter_size=2, stride=1, init_scale=np.sqrt(2), **kwargs))
...
class CustomPolicy(FeedForwardPolicy):
    def __init__(self, *args, **kwargs):
        super(CustomPolicy, self).__init__(cnn_extractor=costum_cnn,*args, **kwargs,
